...
namespace SincomYazilim.WebOnMuhasebe.FaturaHareketler.Concrete;//78
public class SelectFaturaHareketDtoSin : EntityDto<Guid>
{
    ...
    public SelectFaturaDtoSin Fatura { get; set; }
